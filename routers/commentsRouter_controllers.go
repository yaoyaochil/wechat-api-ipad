...
func init() {
	...
	// beego.GlobalControllerRouter["wechatwebapi/controllers:FinderController"] = append(beego.GlobalControllerRouter["wechatwebapi/controllers:FinderController"],
	//     beego.ControllerComments{
	//         Method: "UserPrepare",
	//         Router: `/UserPrepare`,
	//         AllowHTTPMethods: []string{"post"},
	...
	// beego.GlobalControllerRouter["wechatwebapi/controllers:SayHelloController"] = append(beego.GlobalControllerRouter["wechatwebapi/controllers:SayHelloController"],
	//     beego.ControllerComments{
	//         Method: "ModelV1",
	//         Router: `/Modelv1`,
	//         AllowHTTPMethods: []string{"post"},
